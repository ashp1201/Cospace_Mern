...
function Home() {
  ...
  const backgroundImages = [b1, b2, b3, b4, b5, b6];
  ...
  const prevImg = () => {
    setCurrentImgIndex((prevIndex) => (prevIndex - 1 + backgroundImages.length) % backgroundImages.length);
  };
    ...
    <div className='home' >
      <Toaster position="top-center" reverseOrder={false}></Toaster>
         <div className="home_container" id="get-top">
            ...
            <img className='home_image' src={backgroundImages[currentImgIndex]} alt=""  />
